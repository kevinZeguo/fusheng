...
public class UserServiceImpl implements UserService {
    ...
    public static void main(String[] args) {
        System.out.println(PasswordUtil.encrypt("admin", "123456", PasswordUtil.getStaticSalt()));
    }
}
