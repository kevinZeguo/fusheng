var user_list = {};
user_list.queryListUrl = "/user/list.ajax";//查询列表地址
...
user_list.init_event = function () {
    ...
    $("#addUser").click(function () {
        $(".user-body").empty();
        $(".user-body").load('/user/add.html', function () {
...
function editUser(userId) {
    $(".user-body").html("");
    $(".user-body").load('/user/edit.html?userId=' + userId, function () {
        $("#addModal").modal({backdrop: 'static', keyboard: false});
        $("#addModal").modal("show");
    })
}
