var role_list = {};
role_list.queryListUrl = "/role/list.ajax";//查询列表地址
...
role_list.init_event = function () {
    ...
    $("#addRole").click(function () {
        $(".role-body").empty();
        $(".role-body").load('/role/add.html', function () {
...
function editRole(roleId) {
    $(".role-body").html("");
    $(".role-body").load('/role/edit.html?roleId=' + roleId, function () {
        $("#addModal").modal({backdrop: 'static', keyboard: false});
        $("#addModal").modal("show");
    })
}
...
function initFuncTree(roleId) {
    ...
    $.ajax({
        ...
        url: "/role/menulist.ajax?roleId=" + roleId,  //请求的URL路径
...
function addUser() {
    ...
    $(".right-body").empty();
    $(".right-body").load('/role/addUser.html', function () {
